 ...
 * For example:<br>
 * <code>java -DLaflf.selection=0x00cc00 XXX.YOUR.APP.XXX</code> will colour
 * with green the selected widgets<br>
 * <code>java java -DLaflf.s1=0xdde8ee -DLaflf.s2=0xb7daec -DLaflf.s3=0x74bfe6 XXX.YOUR.APP.XXX</code>
 ...
 * <li>Laflf.p1: this is the primary1 color (�Don't you understand?
 * Patience?</li>
 ...
 * </ul>
 * �Primary color? �Secondary? �What the...? Cool.
 * <a href='http://java.sun.com/products/jlf/ed1/dg/higg.htm#62001'>Here</a> you
 * can learn what i'm talking about. Swing applications have only 8 colors,
 * named PrimaryX, SecondaryX, White and Black, and
 * <a href='http://java.sun.com/products/jlf/ed1/dg/higg.htm#62001'>here</a>
 ...
 * If you write Laflf.selection or Laflf.background the LafLF will calculate the
 * colors around (darker and lighter) your choose.<br>
 * If Laflf.selection is writen, pX, sX, b and w are ignored. Ahh!! One more
...
public class LafLookAndFeel extends MetalLookAndFeel {
    ...
    //table.put( "Menu.font", fontMenu);
        ...
        ColorUIResource colAcce = LafUtils.getColorTercio((Color) table.get("MenuItem.foreground"),
                (Color) table.get("MenuItem.acceleratorForeground")
        );
    ...
    // Esto realmente no es necesario porque no se sobrecarga la clase ScrollPaneUI, pero si no se sobrecarga
        ...
        table.put("ToolTip.font", table.get("Menu.font"));

        // Para los Spinners
        table.put("Spinner.editorBorderPainted", false);
        ...
        table.put("LafInternalFrameIconLit.width", 20);
        table.put("LafInternalFrameIconLit.height", 20);

        Font fontIcon = ((Font) table.get("InternalFrame.titleFont")).deriveFont(Font.BOLD);
        table.put("DesktopIcon.font", fontIcon);
        table.put("LafDesktopIcon.width", 80);
        table.put("LafDesktopIcon.height", 60);
        table.put("LafDesktopIconBig.width", 48);
        table.put("LafDesktopIconBig.height", 48);
