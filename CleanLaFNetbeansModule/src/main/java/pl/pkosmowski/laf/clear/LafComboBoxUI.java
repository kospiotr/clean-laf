...
public class LafComboBoxUI extends MetalComboBoxUI {
    ...
    protected JButton createArrowButton() {
        return new LafComboBoxButton(comboBox, UIManager.getIcon("ComboBox.buttonDownIcon"), (comboBox.isEditable()), currentValuePane, listBox);
    }
    ...
    private class LafComboBoxButton extends MetalComboBoxButton {

        private static final long serialVersionUID = 1L;

        LafComboBoxButton(JComboBox cb, Icon icon, boolean editable, CellRendererPane pane, JList list) {
