...
public class LafInternalFrameTitlePane extends MetalInternalFrameTitlePane {
    ...
    private final int litWidth = UIManager.getInt("LafInternalFrameIconLit.width");
    private final int litHeight = UIManager.getInt("LafInternalFrameIconLit.height");

    public LafInternalFrameTitlePane(JInternalFrame arg0) {
        super(arg0);
    ...
    protected PropertyChangeListener createPropertyChangeListener() {
        return new LafPropertyChangeHandler();
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (frame.isSelected()) {
            grad = new GradientPaint(0, 0, LafLookAndFeel.getPrimaryControlDarkShadow(),
                    width, 0, LafLookAndFeel.getPrimaryControl());
        } else {
            grad = new GradientPaint(0, 0, LafLookAndFeel.getControl(),
                    width, 0, LafLookAndFeel.getControlDarkShadow());
        }
        g2D.setPaint(grad);
        ...
        if (frame.getFrameIcon() != antIcon) {
            ...
            resizeIcon = LafUtils.reescala(antIcon, alto, ancho);
        }
        ...
        if (title != null) {
            ...
            if (frame.isSelected()) {
                LafUtils.paintShadowTitleFat(g, title, xOffset, yOffset, Color.white);
            } else {
                LafUtils.paintShadowTitleFat(g, title, xOffset, yOffset, LafLookAndFeel.getControl());
            }
        }
    }
  ...
  //****************************************************
    private class MiML extends MouseInputAdapter {
        ...
        void dodo(MouseEvent ev) {
            if (ev.getComponent() instanceof LafInternalFrameTitlePane) {
    ...
    class LafPropertyChangeHandler extends BasicInternalFrameTitlePane.PropertyChangeHandler {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if (prop.equals(JInternalFrame.IS_SELECTED_PROPERTY)) {
                ...
                ((LafDesktopIconUI) (frame.getDesktopIcon().getUI())).hasFocus = false;
