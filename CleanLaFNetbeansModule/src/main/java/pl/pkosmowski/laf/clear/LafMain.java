...
import static pl.pkosmowski.laf.clear.LafLookAndFeel.ICO_PATH;
 ...
 */
public class LafMain extends JFrame {

    private static final long serialVersionUID = 1L;

    public static LafLookAndFeel nf;
    public static LafTheme nt;
    private static int pos = 0;

    public static void main(String[] args) {
        try {
            nf = new LafLookAndFeel();
            nt = new LafTheme();
            LafLookAndFeel.setCurrentTheme(nt);
    ...
    int index = 0;
    ImageIcon[] lIcon = {LafUtils.loadRes(ICO_PATH + "tools.png"),
        LafUtils.loadRes(ICO_PATH + "folder_picture.png"),
        LafUtils.loadRes(ICO_PATH + "network_local.png"),
        LafUtils.loadRes(ICO_PATH + "news.png"),
        null
    };

    LafMain() {
        super("Laf Look&Feel Theme Configuration");
    ...
    private void hazPreview1() {
        ...
        //LafGradientJPanel p1 = new LafGradientJPanel();
        ...
        //LafGradientJPanel p2 = new LafGradientJPanel();
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                JOptionPane.showMessageDialog(LafMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.ERROR_MESSAGE);
            }
        });
        bots.add(b);
        ...
        b.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ev) {
                JOptionPane.showMessageDialog(LafMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        bots.add(b);
        ...
        b.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ev) {
                JOptionPane.showMessageDialog(LafMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.WARNING_MESSAGE);
            }
        });
        bots.add(b);
        ...
        b.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ev) {
                JOptionPane.showMessageDialog(LafMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.QUESTION_MESSAGE);
            }
        });
        bots.add(b);
    ...
    private void hazPreview3() {
        ...
        //LafGradientJPanel p1 = new LafGradientJPanel( new GridLayout( 2,3, 5,1));
    ...
    private void hazPreview5() {
        ...
        sp.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                pb4.setValue(((Integer) sp.getValue()));
                pb3.setValue(((Integer) sp.getValue()));
            }
        });

        JPanel pp = new JPanel();
        //LafGradientJPanel pp = new LafGradientJPanel();
    ...
    class MiAL implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ev) {
            if (ev.getActionCommand().equals("Open")) {
                ...
                if (fc.showOpenDialog(LafMain.this) != JFileChooser.APPROVE_OPTION) {
                    return;
                }
                String nomFich = fc.getSelectedFile().getPath();
                tNomFich.setText(nomFich);

                nt = new LafTheme(nomFich);
                ...
                if (nomFich.isEmpty()) {
                    fc.setCurrentDirectory(new File("."));
                    fc.setSelectedFile(new File("LafThemeFile.theme"));
                } else {
                    File fich = new File(nomFich);
                    //fc.setCurrentDirectory( fich.getName());
                    fc.setSelectedFile(fich);
                }
                if (fc.showSaveDialog(LafMain.this) != JFileChooser.APPROVE_OPTION) {
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(LafMain.this, "No se puede guardar el fichero");
                }
                ...
                LafFontDialog mm = new LafFontDialog(null, lFont.getFont());
                mm.setVisible(true);
        ...
        protected void cambiaTema() {
            ...
            SwingUtilities.updateComponentTreeUI(LafMain.this);
            hazPaleta();
        }
    }
    ...
    class MiML extends MouseAdapter {
        ...
        protected Color getColor(Color col, String cad) {
            Color ret = JColorChooser.showDialog(LafMain.this, cad, col);
            if (ret == null) {
                ret = col;
            }
